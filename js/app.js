...
/*CLEAR PROPS NOS PERMITE LIMPIAR EL CACHE DE PROPS */
    function nextSlide(pageNumber){
        ...
        .fromTo(nextText, 0.5, {opacity:0, y:10}, {opacity:1, y:0})
        .set(nextLeft, {clearProps: 'all'})
        .set(nextRight, {clearProps: 'all'})
        current = pageNumber;
        //console.log(nextPage)
    }
    //scrool y puntos de menu
    ...
    const hambuergerlines = document.querySelectorAll(".menu line");
    ...
    .fromTo(hamburger, 0.2, {stroke:'white'}, {background: 'black', "borderRadius": "50%"}, "-=1")
